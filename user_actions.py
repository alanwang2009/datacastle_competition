    ...
    for i in range(0,len(cm_data_raw)):
        ...
        if uid not in idlist:
            ...
            for j in range(0,len(udata)):
                ...
                if oudata['actionType']==1:
                    ...
                    if f1==0:
                        ...
                        if j>0:
                            for i in range(1,j):
                                ne1.append(udata.iloc[i-1]['actionTime']-udata.iloc[i]['actionTime'])
                ...
                if oudata['actionType']==2:
                    ...
                    if f2==0:
                        ...
                        if j>0:
                            for i in range(1,j):
                                ne2.append(udata.iloc[i-1]['actionTime']-udata.iloc[i]['actionTime'])
                ...
                if oudata['actionType']==3:
                    ...
                    if f3==0:
                        ...
                        if j>0:
                            for i in range(1,j):
                                ne3.append(udata.iloc[i-1]['actionTime']-udata.iloc[i]['actionTime'])
                ...
                if oudata['actionType']==4:
                    ...
                    if f4==0:
                        ...
                        if j>0:
                            for i in range(1,j):
                                ne4.append(udata.iloc[i-1]['actionTime']-udata.iloc[i]['actionTime'])
                ...
                if oudata['actionType']==5:
                    ...
                    if f5==0:
                        ...
                        if j>0:
                            for i in range(1,j):
                                ne5.append(udata.iloc[i-1]['actionTime']-udata.iloc[i]['actionTime'])
                ...
                if oudata['actionType']==9:
                    ...
                    if f9==0:
                        ...
                        if j>0:
                            for i in range(1,j):
                                ne9.append(udata.iloc[i-1]['actionTime']-udata.iloc[i]['actionTime'])
                ...
                if oudata['actionType']==8:
                    ...
                    if f8==0:
                        ...
                        if j>0:
                            for i in range(1,j):
                                ne8.append(udata.iloc[i-1]['actionTime']-udata.iloc[i]['actionTime'])
                ...
                if oudata['actionType']==7:
                    ...
                    if f7==0:
                        ...
                        if j>0:
                            for i in range(1,j):
                                ne7.append(udata.iloc[i-1]['actionTime']-udata.iloc[i]['actionTime'])
                ...
                if oudata['actionType']==6:
                    ...
                    if f6==0:
                        ...
                        if j>0:
                            for i in range(1,j):
                                ne6.append(udata.iloc[i-1]['actionTime']-udata.iloc[i]['actionTime'])
            ...
            finalud={"userid":uid,'totalStep':totalStep,'step1N':n1,'step2N':n2,'step3N':n3,'step4N':n4,
                     ...
                     'near1':near1,'near2':near2,'near3':near3,'near4':near4,'near5':near5,'near6':6,
                     'near7':near7,'nsar8':near8,'near9':near9,
